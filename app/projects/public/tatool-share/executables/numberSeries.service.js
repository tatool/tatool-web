tatool.factory('numberSeries', [ 'executableUtils', 'stimulusServiceFactory', 'inputServiceFactory', 'dbUtils',
  function (executableUtils, stimulusServiceFactory, inputServiceFactory, dbUtils) {

    var NumberSeries = executableUtils.createExecutable();

    NumberSeries.prototype.init = function() {
    ...
    NumberSeries.prototype.createStimulus = function() {
    ...
    NumberSeries.prototype.processResponse = function(response) {
