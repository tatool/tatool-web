...
tatool
  .factory('memoryClassify4', [ 'executableUtils', 'dbUtils', 'timerUtils', 'gridServiceFactory', 'inputServiceFactory', 'statusPanelUtils',
    ...
    var ANIMALS = ['a_ant', 'a_mosquito', 'a_worm','a_fish','a_bird','a_monkey','a_wolf','a_bear','a_kangaroo','a_elephant','a_whale','a_giraffe'];
    ...
    memoryClassify.prototype.init = function() {
      ...
      // template properties
      this.gridService = gridServiceFactory.createService(4, 4, 'grid', this.stimuliPath);
