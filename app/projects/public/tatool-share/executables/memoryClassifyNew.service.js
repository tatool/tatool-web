...
tatool
  .factory('memoryClassifyNew', [ 'executableUtils', 'dbUtils', 'timerUtils', 'gridServiceFactory', 'inputServiceFactory', 'statusPanelUtils',
    ...
    memoryClassify.prototype.init = function() {
      ...
      // template properties
      this.gridService = gridServiceFactory.createService(1, 3, 'grid', this.stimuliPath);
