...
tatool
  .factory('inhibitionSpatialTaskNew', [ 'executableUtils', 'dbUtils', 'timerUtils', 'stimulusServiceFactory', 'inputServiceFactory',
    ...
    SpatialTask.prototype.init = function() {
      ...
      if (!this.stimuliPath) {
        deferred.reject('Invalid property settings for Executable inhibitionSpatialTask. Expected property <b>stimuliPath</b> of type Path.');
      }
      ...
      if (this.stimuliFile) {
        ...
        deferred.reject('Invalid property settings for Executable inhibitionSpatialTask. Expected property <b>stimuliFile</b> of type Resource.');
      }
    ...
    SpatialTask.prototype.processStimuliFile = function(list, deferred) {
    ...
    SpatialTask.prototype.splitStimuliList = function(list) {
      var newList = {};
    ...
    SpatialTask.prototype.setupInputKeys = function(list) {
      var keys = this.inputService.addInputKeys(list, !this.showKeys.propertyValue);

      if (keys.length === 0) {
        executableUtils.fail('Error creating input template for Executable inhibitionSpatialTask. No keyCode provided in stimuliFile.');
      }
    };

    // Create stimulus and set properties
    SpatialTask.prototype.createStimulus = function() {
      ...
      if (stimulus === null) {
        executableUtils.fail('Error creating stimulus in Executable inhibitionSpatialTask. No more stimuli available in current stimuliList.');
      } else {
    ...
    SpatialTask.prototype.createRandomConditionStimulus = function() {
    ...
    SpatialTask.prototype.createRandomStimulus = function() {
      // get random stimulus out of selected stimuliType
      var  randomStimulus = executableUtils.getNext(this.stimuliList, this.counter);
      return randomStimulus;
    };

    SpatialTask.prototype.createNonRandomStimulus = function() {
    ...
    SpatialTask.prototype.processResponse = function(givenResponse) {
