...
tatool
  .factory('enlearnMemorySpanExecutable', [ 'executableUtils', 'dbUtils', 'timerUtils', 'stimulusServiceFactory', 'inputServiceFactory',
    ...
    var DISPLAY_RECALL_NUMBER = false;
    ...
    MemorySpanExecutable.prototype.init = function() {
      ...
      if (!this.timerEnabled) {
        this.timerEnabled = { propertyValue: true }; // timer is always enabled
      } else {
        this.timerEnabled.propertyValue = (this.timerEnabled.propertyValue === true) ? true : false;
      }
      if (!this.displayRecallNumber.propertyValue){
        this.displayRecallNumber = { propertyValue : false};
      } else {
        this.displayRecallNumber = { propertyValue : true }; 
      }
      // template properties
