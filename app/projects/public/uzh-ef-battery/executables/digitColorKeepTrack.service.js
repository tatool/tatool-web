...
tatool
  .factory('digitColorKeepTrack', [ 'executableUtils', 'dbUtils', 'timerUtils', 'gridServiceFactory', 'inputServiceFactory', 'statusPanelUtils',
    function (executableUtils, dbUtils, timerUtils, gridServiceFactory, inputServiceFactory, statusPanelUtils) {

    var DigitColorKeepTrack = executableUtils.createExecutable();
    ...
    DigitColorKeepTrack.prototype.init = function() {
    ...
    DigitColorKeepTrack.prototype.createStimulus = function() {
    ...
    DigitColorKeepTrack.prototype.setEncodingStimuli = function() {
      this.updateStep = 0;
      this.recallStep = 0;
    ...
    DigitColorKeepTrack.prototype.setUpdatingStimuli = function() {
      this.updateStep++;
    ...
    DigitColorKeepTrack.prototype.setRecallStimuli = function() {
      this.recallStep++;
      this.startTime = 0;
      this.endTime = 0;
    ...
    DigitColorKeepTrack.prototype.getPhase = function() {
      return this.phase;
    };

    DigitColorKeepTrack.prototype.setPhase = function(phase) {
      this.phase = phase;
    };

    // Process given response
    DigitColorKeepTrack.prototype.processResponse = function(givenResponse, timing) {
      this.trial = {};
    ...
    DigitColorKeepTrack.prototype.stopExecution = function() {
      executableUtils.stop();
    };

    return DigitColorKeepTrack;
