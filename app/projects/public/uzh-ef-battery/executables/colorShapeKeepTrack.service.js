...
tatool
  .factory('colorShapeKeepTrack', [ 'executableUtils', 'dbUtils', 'timerUtils', 'gridServiceFactory', 'inputServiceFactory', 'statusPanelUtils',
    function (executableUtils, dbUtils, timerUtils, gridServiceFactory, inputServiceFactory, statusPanelUtils) {

    var ColorShapeKeepTrack = executableUtils.createExecutable();
    ...
    ColorShapeKeepTrack.prototype.init = function() {
    ...
    ColorShapeKeepTrack.prototype.createStimulus = function() {
    ...
    ColorShapeKeepTrack.prototype.setEncodingStimuli = function() {
      this.updateStep = 0;
      this.recallStep = 0;
    ...
    ColorShapeKeepTrack.prototype.setUpdatingStimuli = function() {
      this.updateStep++;
    ...
    ColorShapeKeepTrack.prototype.setRecallStimuli = function() {
      this.recallStep++;
      this.startTime = 0;
      this.endTime = 0;
    ...
    ColorShapeKeepTrack.prototype.getPhase = function() {
      return this.phase;
    };

    ColorShapeKeepTrack.prototype.setPhase = function(phase) {
      this.phase = phase;
    };

    // Process given response
    ColorShapeKeepTrack.prototype.processResponse = function(givenResponse, timing) {
      this.trial = {};
    ...
    ColorShapeKeepTrack.prototype.stopExecution = function() {
      executableUtils.stop();
    };

    return ColorShapeKeepTrack;
