...
tatool
  .factory('letterPositionUpdating', [ 'executableUtils', 'dbUtils', 'timerUtils', 'gridServiceFactory', 'inputServiceFactory', 'statusPanelUtils',
    function (executableUtils, dbUtils, timerUtils, gridServiceFactory, inputServiceFactory, statusPanelUtils) {

    var LetterPositionUpdating = executableUtils.createExecutable();
    ...
    LetterPositionUpdating.prototype.init = function() {
      var deferred = executableUtils.createPromise();

      if (!this.stimuliPath) {
        deferred.reject('Invalid property settings for Executable letterPositionUpdating. Expected property <b>stimuliPath</b> of type Path.');
      }
    ...
    LetterPositionUpdating.prototype.createStimulus = function() {
    ...
    LetterPositionUpdating.prototype.setEncodingStimuli = function() {
      this.updateStep = 0;
      this.recallStep = 0;
    ...
    LetterPositionUpdating.prototype.setUpdatingStimuli = function() {
      this.updateStep++;
    ...
    LetterPositionUpdating.prototype.setRecallStimuli = function() {
      this.recallStep++;
      this.startTime = 0;
      this.endTime = 0;
    ...
    LetterPositionUpdating.prototype.getPhase = function() {
      return this.phase;
    };

    LetterPositionUpdating.prototype.setPhase = function(phase) {
      this.phase = phase;
    };

    // Process given response
    LetterPositionUpdating.prototype.processResponse = function(givenResponse, timing) {
      this.trial = {};
    ...
    LetterPositionUpdating.prototype.stopExecution = function() {
      executableUtils.stop();
    };

    return LetterPositionUpdating;
