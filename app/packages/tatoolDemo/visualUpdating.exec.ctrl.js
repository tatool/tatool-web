...
angular.module('tatool.module')
  .controller('visualUpdatingExecutableCtrl', [ '$scope', '$log', '$timeout', 'service', 'timerService', 
    ...
    $scope.gridCells.push({gridPosition: 2, gridCellSize: '110', stimulusValue: 'penguine_archigraphs_96x96.png', stimulusValueType: 'image'});
    ...
    $timeout(function() {
      ...
      $scope.gridCells.push({gridPosition: 4, gridCellSize: '110', stimulusValue: '', stimulusValueType: 'text'});
    }, 3000);
